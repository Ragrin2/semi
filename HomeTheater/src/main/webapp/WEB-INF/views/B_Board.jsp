                ...
                <div class="blog__details__content" style="min-width: 500px;">
                    <div>
                        <button onclick="location.href='B_writeForm'"
                                style="margin-top: 40px; border: 0; outline: 0; background-color: #0b0c2a; color: white; float: right">
                            글
                            작성하기
                        </button>
                    </div>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr class="list_head">
                            ...
                            <th style="background-color: #24242f;" class="list_small"
                                style="text-align: right;">작성자
                            </th>
                            <th style="background-color: #24242f;" class="list_small"
                                style="text-align: right;">작성일
                            </th>
                            <th style="background-color: #24242f;" class="list_small"
                                style="text-align: right;">조회수
                            </th>
                        </tr>
                        ...
                        <c:forEach var="boardList" items="${boardList}">
                            <tr class="list">
                                <td><a style="padding: 20px 10px 20px 10px;"
                                       href="B_view?BNO=${boardList.BNO}&page=${paging.page}">${boardList.BTITLE}</a>
                                </td>
