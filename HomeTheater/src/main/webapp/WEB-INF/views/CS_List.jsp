                                ...
                                <div class="product__item">
                                    <div class="product__item__pic set-bg">
                                        <a href="C_view?CNum=${list.CNum}&page=${paging.page}">
                                            <img src="C:/Users/djand/Documents/workspace-spring-tool-suite-4-4.11.1.RELEASE/HomeTheater/src/main/webapp/resources/CPoster/${list.CPoster}"
                                                 class="product__item__pic set-bg" style="width:262.5px;"></a>
                                        <!-- 포스터 파일이름 -->
            ...
            <div class="col-lg-6">
                <div class="footer__nav">
                    <ul>
                        ...
                        <li>
                            <c:if test="${empty sessionScope.loginId}"><a
                                    href="M_loginForm">로그인</a></c:if>        <!-- 로그인 페이지로 -->
                            <c:if test="${!empty sessionScope.loginId}"><a
                                    href="M_logout">로그아웃</a></c:if>    <!-- 로그아웃 페이지로 -->
                        </li>
                    </ul>
                </div>
            </div>
