            ...
            <div class="col-lg-8">
                <div class="blog__details__content" style="min-width: 500px;">
                    ...
                    <c:if test="${empty sessionScope.loginId}">
                        <script>
                            alert('로그인 후 사용가능합니다.');
                            location.href = "M_loginForm"; <!-- 맞춰서 수정해 주세요!!! -->
                        </script>
                    </c:if>

                    <div>
                        <form action="B_write" method="POST"
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="wrhit" colspan="2">작성자 ${sessionScope.loginId}<input
                                            type="hidden" name="BWRITER" value="${sessionScope.loginId}"></td>
                                </tr>
                                <tr>
                                    <td class="content"><textarea rows="20" cols="40"
                                                                  name="BCONTENT" placeholder="내용을 입력해주세요."></textarea>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td
                                        ...
                                        <input class="BT_mo" type="submit" value="게시물 등록">
                                    </td>
                                </tr>
                            </table>
                        </form>
