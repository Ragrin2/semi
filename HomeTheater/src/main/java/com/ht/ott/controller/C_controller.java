...
public class C_controller {
    ...
    public @ResponseBody
    String DoubleCheck(@RequestParam(value = "Title") String Title, @RequestParam(value = "CODate") String CODate) {
    ...
    public @ResponseBody
    int cLike(@ModelAttribute MarkDTO mark) {
    ...
    public @ResponseBody
    int cDisLike(@ModelAttribute MarkDTO mark) {
